#!/usr/bin/env python3
"""Post-init hook for the crater scaffold.
...
Responsibilities:
  * Ensure data/ exists with a .gitkeep. data/ is a host-side scratch
    directory students can use freely; the vendor's downloaded gzipped JSONL
    lives inside a docker named volume (gh-archive-cache), not here.
