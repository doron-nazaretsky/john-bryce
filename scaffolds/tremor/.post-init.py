#!/usr/bin/env python3
"""Post-init hook for the tremor scaffold.
...
Responsibilities:
  * Ensure data/ exists with a .gitkeep. data/ is a host-side scratch
    directory students can use freely; the vendor's curated CSVs live inside
    a docker named volume (gdelt-cache), not here.
