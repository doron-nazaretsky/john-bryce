...
- **Late and out-of-order data is a fact, not an exception.** A record arriving 30 seconds late is normal. Your code has to handle it explicitly. (See [Watermarks](06-watermarks.md).)
