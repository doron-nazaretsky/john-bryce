...
The answer is: it depends on **how late is too late**, which is the [watermark](06-watermarks.md). For now: every streaming system needs a policy for lateness, and that policy is a first-class part of the design.
